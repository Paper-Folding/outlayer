...
QUnit.test("offset", function (assert) {
    ...
    assert.equal(Math.round(offset1.left), 40, "stamp1 offset with border left: 40");
    assert.equal(offset1.top, 20, "stamp1 offset with border top: 20");
    assert.equal(Math.round(offset2.right), 50, "stamp2 offset with border right: 50");
    ...
    assert.equal(Math.round(offset1.left), 0, "stamp1 offset with border and padding, left: 0");
    assert.equal(offset1.top, 10, "stamp1 offset with border and padding, top: 10");
    assert.equal(Math.round(offset2.right), 30, "stamp2 offset with border and padding, right: 30");
    ...
    assert.equal(Math.round(offset1.left), 0, "stamp1 offset with margin, left: 0");
    assert.equal(offset1.top, 10, "stamp1 offset with margin, top: 10");
    assert.equal(Math.round(offset2.right), 30, "stamp2 offset with margin, right: 30");
